<aside class="fixed lg:static inset-y-0 left-0 z-40
   ...
   {{ request()->routeIs('admin.brands.*')
        ...
        <a href="{{ route('admin.products.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-3 transition
   {{ request()->routeIs('admin.products.*')
        ...
        <a
            ...
            class="block rounded-lg px-4 py-2 text-slate-600 hover:bg-slate-100">
            🗑 Product Trash
        </a>
